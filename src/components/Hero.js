      ...
      <div className="container px-4 py-12 md:py-20 ">
        <div className="md:w-8/12 lg:w-6/12 flex flex-col items-start lg:mx-10">
          ...
          {[
            ...
            "Expertise in Tax Advisory, Compliance & Litigation Service in India",
          ].map((text, index) => (
            <div
              key={index}
              className="flex items-center py-2 md:py-4 text-white"
            >
        ...
        {[
          {
            ...
            title: "Legal",
            description:
              "Expert lawyers handle all your documents, contracts, and registrations.",
          },
          {
            icon: tax,
            title: "Tax",
            description: "Help to file your return with expert in easier way",
          },
          {
            icon: ca,
            title: "Compliance",
            description: "Our CA & CS will keep your books in order.",
          },
        ].map((service, index) => (
          <div
            key={index}
            className="w-full md:w-4/12 flex justify-center mb-8 md:mb-0"
          >
            <div className="flex flex-col justify-center items-center text-center">
              <img
                ...
                alt={service.title}
              />
              <h3 className="py-3 text-white text-3xl md:text-4xl font-bold">
                {service.title}
              </h3>
