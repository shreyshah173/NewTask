...
const IncomeTaxReturn = () => {
  return (
    <div>
      <div className="bg-gradient-to-b from-[#190889] to-[#0f0b26] text-white px-20 py-4">
        <h1 className="text-3xl font-bold mb-4 bg-yellow-500 rounded-lg text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          <div className="flex flex-col space-y-4 mx-4">
            <div className="flex items-center py-2">
              ...
              <p className="ml-2 text-xl font-semibold ">
                Filing ITR Return within 6 hour or get full refund.
              </p>
            </div>
            <div className="flex items-center py-2">
            ...
            <div className="flex items-center py-2">
              <span className="text-2xl">🔍</span>
              <p className="ml-2 text-xl font-semibold">
                Detailed Internal Scrutiny by Tax Experts to help Reduce & Save
          ...
          <div className="flex flex-col space-y-4 mx-4">
            ...
            <div className="flex items-center py-2">
              <span className="text-2xl">👨‍⚖️</span>
              <p className="ml-2 text-xl font-semibold">
                Computation of Profit & Loss, Balance Sheet Drafting Service
                provided for Free
              </p>
            </div>
            <div className="flex items-center py-2">
